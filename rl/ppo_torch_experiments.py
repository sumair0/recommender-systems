...
def main(kwargs: dict):
    ...
    envs = SubprocVecEnv([lambda: gym.make(recommendation_env.RecoEnv.id,
                                           **recommendation_env.import_data_for_env())
    ...
    model = PPO("MLPPolicy", env=envs, **ppo_configs)
    ...
    recommendation_env.evaluate(model=model,
                                env=gym.make(recommendation_env.RecoEnv.id,
                                             **recommendation_env.import_data_for_env()),
